...
public class FuentesBuenosvinosGuillermo2425T4 {
    ...
    public FuentesBuenosvinosGuillermo2425T4(){}
    //constructor con parámetros para inicializar todas las propiedades de la clase
    public FuentesBuenosvinosGuillermo2425T4(String nom, int cantidad, double precio, double saldo){
